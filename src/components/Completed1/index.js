    ...
    <Column className={`  ${props?.className} `}>
      <header className="mx-[auto] self-stretch w-[100%]">
        <Column className="bg-colors1 items-center justify-end mx-[auto] self-stretch w-[100%]">
          ...
          <Line className="2xl:mt-[18px] 3xl:mt-[21px] bg-colors4 h-[1px] lg:mt-[14px] mt-[24px] mx-[auto] w-[85%] xl:mt-[16px]" />
        </Column>
      </header>
    </Column>
  );
